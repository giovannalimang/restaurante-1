...
class Prato:
    def __init__(self, id, name,descr,preco,imagem):
        self.id = id
        self.name = name
        self.descr=descr
        self.preco = preco
...
listaPratos.append(Prato(3, "Frango","Peitodb.Column(db.String(80), nullable=False) ou coxa de frango suculenta, assada ou grelhada, com temperos que destacam o sabor caseiro e aconchegante.",45.00, "menu3.jpg"))
...
class Funcionario(db.Model):
    ...
    salario=db.Column(db.String(120), nullable=False)
